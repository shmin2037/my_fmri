...
import argparse
import shutil
from utils.learning.custom_train_part import train
...
<<<<<<< HEAD
    ...
    parser.add_argument('--inchans', type=int, default=1, help='Size of input channels for network')
    parser.add_argument('--outchans', type=int, default=1, help='Size of output channels for network')
